...
@Component({
	template: `
		<os-content-switcher (selected)="selected($event)" ariaLabel="Test">
			<button osContentOption name="First" id="first">First section</button>
			<button osContentOption name="Second" id="second">Second section</button>
			<button osContentOption name="Third" id="third">Third section</button>
		</os-content-switcher>
	`
})
...
describe("ContentSwitcher", () => {
	...
	it("should set arialabel to 'Test'", () => {
		...
		element = fixture.debugElement.query(By.css("os-content-switcher"));

...
storiesOf("Components|Tooltip Icon", module)
	...
	.add("Basic", () => ({
		template: `
			<os-tooltip-icon [placement]="placement" [alignment]="alignment" [content]="content">
	...
	.add("Documentation", () => ({
		template: `
			<os-documentation src="documentation/components/TooltipIcon.html"></os-documentation>
		`
	}));

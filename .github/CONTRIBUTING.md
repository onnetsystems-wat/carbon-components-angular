...
1. Fork the project by navigating to the main [repository](https://github.com/os/@onnetsystems-wat/onnet-design-systems) and clicking the **Fork** button on the top-right corner.
...
3. Once cloned, you will see `origin` as your default remote, pointing to your personal forked repository. Add a remote named `upstream` pointing to the main `@onnetsystems-wat/onnet-design-systems`:
   ...
   ```
   $ git remote add upstream git@github.com:os/@onnetsystems-wat/onnet-design-systems.git
   $ git remote -v
   ```
...
8. In Github, navigate to [os/carbon-components-react](https://github.com/os/carbon-components-react) and click the button that reads "Compare & pull request".
